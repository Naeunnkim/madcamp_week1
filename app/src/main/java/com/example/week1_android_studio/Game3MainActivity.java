...
public class Game3MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), Game3SelectActivity.class);
