...
public class Game2MainActivity extends AppCompatActivity implements View.OnClickListener{
...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), Game2SelectActivity.class);
